...
test('should be able to use wasm inside of a web worker', async () => {
...
test('should be able to use native code inside of a web worker', async () => {
  const dag = new DirectedAcyclicGraph<number>({
    vertices: defaultDagVertices,
    edges: defaultDagEdges
  });
...
test('should be able to use wasm in the main thread', async () => {
  const dag = new DirectedAcyclicGraph<number>({
    vertices: defaultDagVertices,
    edges: defaultDagEdges
  });
...
test('should be able to use native code in the main thread', async () => {
  const dag = new DirectedAcyclicGraph<number>({
    vertices: defaultDagVertices,
    edges: defaultDagEdges
  });
...
test('should be able to add edges and vertices', () => {
  const dag = new DirectedAcyclicGraph<number>();
...
test('should be able to detect cycles, using wasm inside a web worker', async () => {
  const dag = new DirectedAcyclicGraph<number>({
    vertices: defaultDagVertices,
...
test('should be able to detect cycles, using native code inside a web worker', async () => {
  const dag = new DirectedAcyclicGraph<number>({
    vertices: defaultDagVertices,
    edges: defaultCyclicEdges
  });
...
test('should be able to detect cycles, using wasm in the main thread', async () => {
  const dag = new DirectedAcyclicGraph<number>({
    vertices: defaultDagVertices,
    edges: defaultCyclicEdges
  });
...
test('should be able to detect cycles, using native code in the main thread', async () => {
  const dag = new DirectedAcyclicGraph<number>({
    vertices: defaultDagVertices,
    edges: defaultCyclicEdges
  });
